...
return new class extends clsListagem {
    ...
    {
        $this->titulo = __('Escolaridade - Listagem');
        ...
        // Outros Filtros
        $this->campoTexto('descricao', __('Descrição'), $this->descricao, 30, 255, false);
        ...
        $this->breadcrumb(__('Escolaridade do servidor'), [
    ...
    {
        $this->title = __('Escolaridade do servidor');
        $this->processoAp = '632';
    }
};
