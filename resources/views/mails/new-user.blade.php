                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        Agora você tem acesso ao i-Educar, a plataforma que automatiza
                                                        os processos da
                                                    ...
                                                    <p
                                                        style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                        Você pode alterar sua senha para uma de sua preferência ao fazer
                                                        login no
                                                        sistema e em seguida ir em "Meus Dados" localizado no menu do
                                                        topo
                                                    </p>
                                                    @if($url)
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Se você tiver problemas ao clicar no botão "Ir ao
                                                                        i-Educar",
                                                                        copie
